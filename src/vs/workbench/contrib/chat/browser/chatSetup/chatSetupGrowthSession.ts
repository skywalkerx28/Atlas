...
export class GrowthSessionController extends Disposable implements IChatSessionItemController {
	...
	get items(): readonly IChatSessionItem[] {
		...
		return [{
			...
			label: localize('growthSession.label', "Try Atlas"),
			description: localize('growthSession.description', "Atlas agent features are available. Try them here."),
