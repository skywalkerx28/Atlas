...
- `jsonc` documents additionally accept single line (`//`) and multi-line comments (`/* ... */`). JSONC is a Atlas specific file format, intended for Atlas configuration files, without any aspirations to define a new common file format.
...
The JSON language server is shipped with [Atlas](https://github.com/skywalkerx28/Atlas) as part of the built-in Atlas extension `json-language-features`. The server is started when the first JSON file is opened. The [Atlas JSON documentation](https://github.com/skywalkerx28/Atlas) for detailed information on the user experience and has more information on how to configure the language support.
...
The source code of the JSON language server can be found in the [Atlas repository](https://github.com/skywalkerx28/Atlas) at [extensions/json-language-features/server](https://github.com/skywalkerx28/Atlas/tree/master/extensions/json-language-features/server).

File issues and pull requests in the [Atlas GitHub Issues](https://github.com/skywalkerx28/Atlas/issues). See the document [How to Contribute](https://github.com/skywalkerx28/Atlas/wiki/How-to-Contribute) on how to build and run from source.
...
Licensed under the [MIT](https://github.com/skywalkerx28/Atlas/blob/master/LICENSE.txt) License.
