...
To view this, it needs to be hosted by a web server. The easiest way is to open the file with the `Open with Live Server` command from the [Live Server extension](https://github.com/skywalkerx28/Atlas).
...
- have the main branches of `https://github.com/jesseweed/seti-ui` and `https://github.com/skywalkerx28/Atlas` cloned in the same parent folder
...
- when done, create a PR with the changes in https://github.com/skywalkerx28/Atlas.
